...
export interface Category {
  ...
  judgeModel?: string  // per-category judge model override (undefined = use global judge)
  judgeProvider?: string // per-category judge provider override (undefined = use global judge provider)
}
